...
module.exports = function (reporter, definition) {
  ...
  reporter.documentStore.on('after-init', () => {
    if (reporter.documentStore.model.entityTypes['AssetType']) {
      reporter.documentStore.model.entityTypes['AssetType'].isMetaReadOnly = { type: 'Edm.Boolean' }
    }

    provider.registerAssetType(reporter.documentStore.model.entityTypes['AssetType'])
  })
